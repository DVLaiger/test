...
function ale_enqueue_styles() {
	...
	wp_register_style( 'aletheme_bootstrap', THEME_URL . '/css/vendor/bootstrap/bootstrap.css', array(), ALETHEME_THEME_VERSION, 'all');

    wp_enqueue_style('aletheme_general_css');
    wp_enqueue_style('aletheme_fontawesome_css');
    wp_enqueue_style('aletheme_bootstrap');
}
...
function ale_enqueue_scripts() {
    ...
    wp_register_script( 'myjs', THEME_URL . '/js/main.js', array( 'jquery' ), ALETHEME_THEME_VERSION, true );
    wp_register_script( 'jquery.bootstrap.min', get_template_directory_uri() . '/js/bootstrap/bootstrap.min.js', 'jquery');
